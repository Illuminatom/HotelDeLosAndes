...
public interface MaquinasGimnasioRepository extends JpaRepository<MaquinasGimnasio, Integer>{
    @Query(value = "SELECT * FROM maquinas_gimnasio", nativeQuery = true)
    Collection<MaquinasGimnasio> darMaquinasGimnasios();

    @Query(value = "SELECT * FROM maquinas_gimnasio WHERE Gimnasio_id=:Gimnasio_id AND Producto_id=:Producto_id", nativeQuery = true)
    MaquinasGimnasio darMaquinasGimnasio(@Param("Gimnasio_id") int Gimnasio_id, @Param("Producto_id") int Producto_id);

    @Modifying
    @Transactional
    @Query(value = "INSERT INTO maquinas_gimnasio (Gimnasio_id, Producto_id) VALUES (:Gimnasio_id, :Producto_id)", nativeQuery = true)
    void insertarMaquinaGimnasio(@Param("Gimnasio_id") int Gimnasio_id, @Param("Producto_id") int Producto_id);

    @Modifying
    @Transactional
    @Query(value = "UPDATE maquinas_gimnasio SET Gimnasio_id=:Gimnasio_id_actualizado, Producto_id=:Producto_id_actualizado WHERE Gimnasio_id=:Gimnasio_id AND Producto_id=:Producto_id", nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "DELETE FROM maquinas_gimnasio WHERE Gimnasio_id=:Gimnasio_id AND Producto_id=:Producto_id", nativeQuery = true)
